...
export function Sidebar() {
  return (
    <aside className='flex flex-col gap-6 p-4 border-b border-zinc-200 fixed left-0 top-0 right-0 bottom-0 z-20 bg-white lg:right-auto lg:w-80 lg:border-r lg:px-5 lg:py-8 lg:relative'>
      <Logo />
      <InputRoot>
        <InputPrefix>
