...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
  return (
    <Tabs.Trigger 
      value={value} 
      className='relative px-1 pb-4 text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-violet-700 data-[state=active]:text-violet-700 dark:hover:text-violet-300 dark:data-[state=active]:text-violet-300 outline-none group'
    >
